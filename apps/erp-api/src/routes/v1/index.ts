...
export async function apiV1Routes(fastify: FastifyInstance) {
  ...
  await fastify.register(async (protectedRoutes) => {
    ...
    await protectedRoutes.register(purchaseOrderRoutes, {
      prefix: "/purchase-orders",
    });
    await protectedRoutes.register(goodsReceiptRoutes, {
      prefix: "/goods-receipts",
    });
    await protectedRoutes.register(requisitionRoutes, {
      prefix: "/requisitions",
    });
    ...
    await protectedRoutes.register(uomConversionRoutes, {
      prefix: "/uom-conversions",
    });
    ...
    await protectedRoutes.register(temperatureLogRoutes, {
    ...
    await protectedRoutes.register(permissionsRoutes, {
      prefix: "/permissions",
    });
  });
}
